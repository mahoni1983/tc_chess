...
def main():
    number_of_letters = get_next_line_from_input()
    letters = get_next_line_from_input().split()
    letters_in_one_combination = int(get_next_line_from_input())
    all_combinations = list(combinations(letters, letters_in_one_combination))
    number_of_all_combinations = len(list(all_combinations))

    needed_letter = 'a'
    combinations_with_needed_letter = [comb for comb in all_combinations if needed_letter in comb]
    number_of_combinations_with_needed_letter = len(combinations_with_needed_letter)

    # sys.stdout.write(f'{number_of_combinations_with_needed_letter/number_of_all_combinations:.3f}')
    sys.stdout.write(f'{number_of_combinations_with_needed_letter/number_of_all_combinations}')
