...
Concept Python is a fully object-oriented language like C++, Java, etc. For reading about classes, refer here.
...
__add__-> Can be overloaded for + operation __sub__ -> Can be overloaded for - operation __mul__ -> Can be overloaded
for * operation """
...
if __name__ == '__main__':
    ...
    print(f)
    print('division:', c/d)
    print('expected:', 16/61, -7/61)
    print(f'modulus {c}: {c.mod()}')
